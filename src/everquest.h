...
**
** Sample wire bytes (from showeq-daemon inventory.opcodestats.txt,
...
** (Crescent Gi, Platinum Fire Wedding Ring, Outstanding
** Necklace/Mask/Band of Distant Echoes).
**
** Offsets are relative to the start of the post-name region, which
** begins right after the second null terminator of the duplicated
** item-name + lore-name strings.
**
...
/*0004*/ uint32_t spellId;   // spell id
/*0008*/ int16_t  action;    // 1=begin, 2=complete, 3=zone-in sync (wire-verified)
